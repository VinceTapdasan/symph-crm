  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: "text-ssm font-semibold text-slate-900 dark:text-white",
        ...
        head_row: "flex",
        head_cell:
          "text-slate-400 rounded-md w-9 font-normal text-xxs dark:text-slate-500",
        ...
        day_today: "bg-slate-100 dark:bg-white/[.08] text-slate-900 dark:text-white rounded-full",
        day_outside:
